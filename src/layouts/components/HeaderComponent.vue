  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <router-link class="nav-link" active :to="{name: 'lacarte.home'}">Quero um projeto ou serviço</router-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <router-link class="nav-link" active :to="{name: 'lacarte.home'}">Conectar</router-link>
        </li>
        <li class="nav-item">
